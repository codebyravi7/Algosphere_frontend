...
function Footer() {
  return (
    <footer className="bg-gray-100 dark:bg-gray-700 text-black dark:text-white">
            ...
            <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    <li>
                      <a href="/aiplatform" className="text-md leading-6 ">
                        AI Platform
                      </a>
                    </li>
                    <li>
                      <a href="/aialgorithms" className="text-md leading-6 ">
                        AI Algorithms
                      </a>
                    </li>
                    <li>
                ...
                <div className="mt-10 md:mt-0">
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    ...
                    <li>
                      <a href="/automation" className="text-md leading-6 ">
                        Automation
                      </a>
                    </li>
                  </ul>
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    <li>
                      <a href="/pricing" className="text-md leading-6 ">
                        Pricing
                      </a>
                    </li>
                    <li>
                      <a href="/blog" className="text-md leading-6 ">
                        Blog
                      </a>
                    </li>
                    <li>
                      <a href="/casestudies" className="text-md leading-6 ">
                        Case Studies
                      </a>
                    </li>
                    <li>
                ...
                <div className="mt-10 md:mt-0">
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    ...
                    <li>
                      <a href="/careers" className="text-md leading-6 ">
                        Careers
                      </a>
                    </li>
                    <li>
                      <a
                        href="/contactus"
                        className="text-md leading-6 text-gray-300 hover:text-gray--300 hover:text-gray-50"
                      >
                        Contact Us
                      </a>
                    </li>
